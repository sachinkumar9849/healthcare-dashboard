...
const Chart: React.FC<ChartProps> = ({ patient }) => {
    if (!patient || !patient.diagnosis_history || patient.diagnosis_history.length === 0) {
        return (
            <div className="bg-white rounded-[12px]">
                <h3 className="text-[#072635] text-lg font-bold mb-4">Blood Pressure Chart</h3>
    ...
    const labels = sortedHistory.map(item => `${item.month.substring(0, 3)}, ${item.year}`);
    const systolicData = sortedHistory.map(item => item.blood_pressure.systolic.value);
    const diastolicData = sortedHistory.map(item => item.blood_pressure.diastolic.value);
    ...
    return (
        <div className="bg-white  rounded-[12px]">
            ...
            <div className="grid grid-cols-12 gap-6 bg-[#F4F0FE] p-5 rounded-[12px]">
                <div className="col-span-8">
                    <div className="flex justify-between items-center mb-6">
                <h3 className="text-[#072635] text-lg font-bold">Blood Pressure</h3>
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            <div>
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className="text-sm font-semibold text-[#072635]">Systolic</span>
                                </div>
                            ...
                            <div>
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className="text-sm font-semibold text-[#072635]">Diastolic</span>
                                </div>
                                <p className="text-2xl font-bold text-[#072635]">
